...
function wdwt_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'YouTube WD', // The plugin name.
			'slug'               => 'wd-youtube', // The plugin slug (typically the folder name).
			//'source'             => get_stylesheet_directory() . '/lib/plugins/tgm-example-plugin.zip', // The plugin source.
			'required'           => false, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
...
function wdwt_plugins_description($slug){
	...
	switch ($slug) {
		...
		case 'wd-mailchimp':
			...
			break;
		case 'wd-youtube':
			$string = 'YouTube WD lets you easily integrate YouTube with your WordPress site and showcase the content in a mobile-friendly layout.' ;
			break;
		default:
			/*do nothing*/
	}
