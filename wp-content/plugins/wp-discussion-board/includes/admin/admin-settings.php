...
if( ! function_exists( 'ctdb_general_page_settings' ) ) {
	function ctdb_general_page_settings() {
		...
		$messages_settings = apply_filters( 'ctdb_general_messages_settings', $messages_settings );
		...
		$login_settings = apply_filters( 'ctdb_general_login_settings', $login_settings );
		...
		$moderation_settings = apply_filters( 'ctdb_general_moderation_settings', $moderation_settings );
		...
		$notification_settings = apply_filters( 'ctdb_general_notification_settings', $notification_settings );
		
		
		$settings = array_merge( $settings, $login_settings, $moderation_settings, $notification_settings, $messages_settings );
