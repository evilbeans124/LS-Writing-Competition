...
if( ! class_exists( 'CT_DB_Admin' ) ) { // Don't initialise if there's already a Discussion Board activated
	...
	class CT_DB_Admin {
		...
		public function register_user_init() {
			...
			add_settings_field( 
				'email_blacklist',
				__( 'Email blacklist', 'wp-discussion-board' ),
				array( $this, 'email_blacklist_render' ),
				'ctdb_user',
				'ctdb_user_section'
			);
		...
		*/
			...
			<div class="wrap">
				...
				<div class="ctdb-outer-wrap">
					...
					<div class="ctdb-banners">
						...
						<div class="ctdb-banner">
							<a href="http://catapultthemes.com/?utm_source=plugin_ad&utm_medium=wp_plugin&utm_content=ctdb&utm_campaign=themes"><img src="<?php echo DB_PLUGIN_URL . 'assets/images/themes-ad1.jpg'; ?>" alt="" ></a>
						</div>			
					</div>
				</div><!-- .ctdb-outer-wrap -->
			</div><!-- .wrap -->
		...
		public function filter_action_links( $links ) {
			...
			$links['support'] = '<a href="https://catapultthemes.com/support">' . __( 'Support', 'wp-discussion-board' ) . '</a>';
